    ...
    return (
      <div>
        <h2 id="center-heading">
          <Translate contentKey="testreactApp.center.home.title">Centers</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="testreactApp.center.home.createLabel">Create new Center</Translate>
          </Link>
        </h2>
