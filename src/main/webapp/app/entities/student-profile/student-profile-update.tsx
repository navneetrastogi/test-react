    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="testreactApp.studentProfile.home.createOrEditLabel">
              <Translate contentKey="testreactApp.studentProfile.home.createOrEditLabel">Create or edit a StudentProfile</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
