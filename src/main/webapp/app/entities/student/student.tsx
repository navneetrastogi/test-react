    ...
    return (
      <div>
        <h2 id="student-heading">
          <Translate contentKey="testreactApp.student.home.title">Students</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="testreactApp.student.home.createLabel">Create new Student</Translate>
          </Link>
        </h2>
